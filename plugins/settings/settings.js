...
module.exports = [
    ...
    // ==================== SET PROFILE PICTURE (FIXED WITH JIMP) ====================
    {
        command: "setpp",
        ...
        owner: true,
        execute: async (sock, m, { reply }) => {
            if (!m.quoted) return reply("❌ Reply to an image to set as profile picture!");
            
            const msg = m.quoted.message;
            const type = Object.keys(msg)[0];
            
            if (type !== 'imageMessage') return reply("❌ Reply to an IMAGE!");
            ...
            try {
                ...
                // Process with Jimp - resize to WhatsApp PP requirements
                ...
                try {
                    ...
                    reply(`❌ Failed! Image may be too large. Try a smaller image (under 500KB).`);
                }
            }
        }
    },
