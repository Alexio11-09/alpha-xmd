...
const getCountry = (jid) => {
    ...
    try {
        // Try to use awesome-phonenumber if installed
        const PhoneNumber = require('awesome-phonenumber');
        
        // Clean the JID to get just the number
        let number = jid.replace(/[^0-9]/g, '');
        
        // Add '+' prefix as required by the library
        ...
        // Fallback to manual detection if library not installed
