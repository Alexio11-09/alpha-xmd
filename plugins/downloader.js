// © 2026 Alpha - DOWNLOADERS (WITH PLAY BRANDING)
...
console.log("✅ Downloaders Loaded! (With Play Branding)");

module.exports = [
    
    // ==================== PLAY (WITH NEWSLETTER BRANDING) ====================
    {
        command: "play",
        aliases: ["song", "music"],
        category: "downloader",
