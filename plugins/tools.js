...
module.exports = [
    ...
    // 5. STICKER MAKER (FIXED – using downloadContentFromMessage like VV)
    {
        ...
        execute: async (s, m, { reply }) => {
            ...
            if (!msgType) return reply("❌ Reply to an image or video!");
    ...
    // 6. STICKER TO IMAGE (FIXED – same robust method)
    {
