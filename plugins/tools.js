// © 2026 Alpha - TOOLS (STICKER & TOIMG via LIBRARY EXIF)
...
// Helper: convert webp buffer to PNG image buffer
async function webpToImage(webpBuffer) {
    const img = new webp.Image();
    await img.load(webpBuffer);
    const frame = img.frames[0];  // first frame
...
module.exports = [
    ...
    // 5. STICKER MAKER (USING LIBRARY EXIF)
    {
        ...
        execute: async (s, m, { reply }) => {
            ...
            try {
                ...
                // Convert to sticker using your exif library
    ...
    // 6. STICKER TO IMAGE (USING node-webpmux)
    {
        ...
        execute: async (s, m, { reply }) => {
            ...
            try {
                ...
                const pngBuffer = await webpToImage(webpBuffer);
