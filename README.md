<div align="center">
  ...
  <p>
    ...
    <a href="https://whatsapp.com/channel/0029Vb7nHdBFnSzBDbvL6y1X">
      <img src="https://img.shields.io/badge/📢_CHANNEL-Join_Now-25D366?style=for-the-badge&logo=whatsapp&logoColor=white" alt="Channel"/>
    </a>
  </p>
...
<div align="center">
  <table>
    <tr>
      <td>🚀 100+ Commands</td>
      <td>🛡️ Anti‑Link & Anti‑Delete</td>
      <td>🎵 Song on Menu</td>
    </tr>
    <tr>
      <td>📥 Media Downloaders</td>
      <td>👥 Group Management</td>
      <td>🖥️ Panel Delivery</td>
    </tr>
    <tr>
      <td>🎨 Fancy Antidelete Cards</td>
...
| **Koyeb** | [![Deploy to Koyeb](https://www.koyeb.com/static/images/deploy/button.svg)](https://app.koyeb.com/deploy?type=git&repository=github.com/Alexi01-09/alpha-xmd) | 24/7 Free |
| **Render** | [![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/Alexi01-09/alpha-xmd) | 24/7 Free |
...
Grab videos from TikTok, Instagram, Facebook, Twitter, and more — fast, no watermark.

### 🛡️ Advanced Group Protection
Anti‑link with delete/warn/kick modes, anti‑delete detection with fancy cards, and anti‑edit logs — your groups stay safe.

### 🎵 Menu with a Beat
Type `.menu` and watch the loading bar deliver the full command list *plus* an Evil Jordan intro song — premium vibes.

### 🖥️ Panel Delivery System
Store server logins by type (1gb, 2gb, … unlimited, admin) and send them to users with one command — perfect for hosting businesses.

### 🔁 One‑Click Pairing
No QR hassles — `.pair` generates a code instantly, and the bot automatically follows your channel.
...
Pull requests are welcome! Fork → create a branch → make your changes → open PR.  
Let’s build the ultimate bot together 🤝
...
<div align="center">
  <img src="https://github-readme-stats.vercel.app/api/pin/?username=Alexi01-09&repo=alpha-xmd&theme=radical" alt="Repo Stats"/>
</div>
