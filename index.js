...
// ==================== SUPABASE PAIRING SYSTEM (TEMPORARILY DISABLED) ====================
// const { createClient } = require('@supabase/supabase-js');

// const SUPABASE_URL = 'https://xyuvbrhwnmexplokeiun.supabase.co';
// const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inh5dXZicmh3bm1leHBsb2tlaXVuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzU4MjEwMzYsImV4cCI6MjA5MTM5NzAzNn0.6Al-rFlqQDfRMxnk3D7CbuM4Hp-autXOxLYJYSk-wKo';

// const supabase = createClient(SUPABASE_URL, SUPABASE_ANON_KEY);

// console.log('🌐 Supabase Pairing System Active!');
// console.log('👂 Bot is listening for pairing requests...');

// let pairingInterval = null;

// function startPairingListener(sock) {
...
//                 console.log(`📱 Processing pairing for: ${req.phone}`);
//                 
//                 try {
//                     const code = await sock.requestPairingCode(req.phone);
//                     
//                     await supabase
//                         .from('pairing_requests')
//                         .update({ 
...
//                         .eq('id', req.id);
//                     
//                     console.log(`✅ Pairing code sent for: ${req.phone}`);
//                     
//                 } catch (err) {
//                     await supabase
//                         .from('pairing_requests')
...
//                         .eq('id', req.id);
//                     
//                     console.log(`❌ Pairing failed for ${req.phone}: ${err.message}`);
//                 }
//             }
//         } catch (err) {
//             console.error('Pairing loop error:', err.message);
//         }
//     }, 3000);
// }
...
const clientstart = async () => {
  ...
  // 🔥 SUPABASE LISTENER (TEMPORARILY DISABLED)
  // startPairingListener(sock);
